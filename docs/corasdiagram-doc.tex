...
\begin{description}
  ...
  \item[\texttt{corasthreatdiagram}] Threat sources, vulnerabilities, threat
    scenarios, unwanted incidents, impacted assets, and threat scopes.
  \item[\texttt{corasriskdiagram}] Threat sources, risks, assets, and risk
    group containers.
...
Macro & Meaning \\
\hline
\textbackslash corascauses & Solid causal edge. \\
\textbackslash corasrelates & Solid relation/impact edge. \\
...
\textbackslash corastreats & Dashed treatment edge. \\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
  ...
  \item \texttt{scope}
  \item \texttt{fit}
  \item \texttt{kind=system|asset-scope|analysis|risk-group|treatment-scope}
  \item \texttt{padding}
...
The \texttt{asset-scope} kind renders a rounded container and can draw the
stakeholder corner compartment shown in the asset-diagram notation examples.
...
\begin{itemize}
  ...
  \item \texttt{scope} for fit-based container grouping
...
\begin{corasthreatdiagram}[x=.75cm,y=.75cm]
  \corasthreataccidental[name=doc-employee,at={(0,0)},title={Employee}]
  \corasscenario[
    name=doc-remote,
    at={(2.6,.2)},
    title={Remote access},
  ...
  \corascauses[from=doc-employee,to=doc-remote]
  \corascauses[from=doc-remote,to=doc-oldweb]
  \corascauses[from=doc-oldweb,to=doc-disclosure]
...
\begin{corastreatmentdiagram}[x=.75cm,y=.75cm]
  \corasthreataccidental[name=doc-user,at={(0,0)},title={Employee}]
  \corasscenario[
    name=doc-threat,
    at={(2.6,.2)},
    title={Remote access},
  ...
  \corascauses[from=doc-user,to=doc-threat]
...
\begin{corastreatmentoverviewdiagram}[x=.75cm,y=.75cm]
  ...
  \corasjunction[name=doc-junction,at={(3.8,-1.5)}]
  \corastreatment[
    name=doc-treatment1,
    at={(1.8,-3.2)},
    title={Limit access}
