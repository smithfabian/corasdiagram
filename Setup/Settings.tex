...
\IfFileExists{Resources/Typography/NeoSansPro-Medium.otf}
{ %If True set headings to NeoSans Pro
  \newfontface\NeoSansProReg{NeoSansPro-Regular}[Path=Resources/Typography/,Extension=.otf]
  \newfontface\NeoSansProMed{NeoSansPro-Medium}[Path=Resources/Typography/,Extension=.otf]
...
\titlespacing
\chapter{0pt}{0pt plus 4pt minus 2pt}{4pt plus 2pt minus 2pt}
\titlespacing
\section{0pt}{12pt plus 3pt minus 3pt}{2pt plus 1pt minus 1pt}
\titlespacing
\subsection{0pt}{8pt plus 2pt minus 2pt}{0pt plus 1pt minus 1pt}
\titlespacing
\subsubsection{0pt}{4pt plus 1pt minus 1pt}{-2pt plus 1pt minus 1pt}
...
\fancypagestyle{main}{% All normal pages
  ...
  \fancyfoot[L]{\footnotesize \thesistitle} % - \rightmark
...
\fancypagestyle{plain}{% Chapter pages
  ...
  \renewcommand{\headrulewidth}{0pt}
  \fancyfoot[R]{\footnotesize \thepage}
  \fancyfoot[L]{\footnotesize \thesistitle} % - \leftmark
  \fancyhfoffset[L,R]{0pt}
}
