\chapter{Template examples of figures, tables, equations and listings}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth]{Resources/Logos/dtured_cmyk.pdf}
...
\centering
\includegraphics[width=.4\linewidth]{Resources/Logos/dtured_cmyk.pdf}
\caption{A subfigure}
\label{fig:twosub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
\centering
\includegraphics[width=.4\linewidth]{Resources/Logos/black_cmyk.pdf}
\caption{A subfigure}
\label{fig:twosub2}
\end{subfigure}
...
\centering
\includegraphics[width=.3\linewidth]{Resources/Logos/dtured_cmyk.pdf}
\caption{A subfigure}
\label{fig:foursub1}
\end{subfigure}%
\begin{subfigure}{.49\textwidth}
\centering
\includegraphics[width=.3\linewidth]{Resources/Logos/black_cmyk.pdf}
\caption{A subfigure}
\label{fig:foursub2}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
